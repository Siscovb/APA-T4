...
<img src="img/test_1.png" width="640" align="center">
<img src="img/test_2.png" width="640" align="center">
...
def aleat(m=2**31 - 1, a=1103515245, c=12345, x0=1212121):
    '''
    Esta función realiza la misma operación que la clase previa. Primero asignamos valores. Luego creamos un bucle en el cual actualizamos el valor de x en cada iteración y lo devolvemos utilizando el método yield. Cada vez que num tenga un nuevo valor, se realizará el retorno y se mostrarán los números.
